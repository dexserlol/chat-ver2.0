...
function Autorization(props) {
    ...
    function register(e){
        fetch(`https://node-back-chat.herokuapp.com/reg?username=${username}&password=${password}`)
        .then((response) => {
    ...
    function loginned(e){
        fetch(`https://node-back-chat.herokuapp.com/log?username=${username}&password=${password}`)
        .catch(()=>{
            alert("test");
        })
        .then((response) => {
